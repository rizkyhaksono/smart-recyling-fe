            ...
            <form className="flex-auto p-6 mt-7">
              ...
              <div className="flex space-x-4 mb-6 text-sm font-medium pt-4">
                <div className="flex-auto flex space-x-4">
                  ...
                  <button className="h-10 px-6 font-semibold rounded-md border border-primary text-primary" type="button" onClick={showModal}>
                    Detail
                  </button>
                  {/* Start modal */}
                  <Modal
                    ...
                    footer={[
                      <Button className="h-10 px-6 font-semibold rounded-md bg-primary text-white" key="back" onClick={handleCancel}>
                        Return
                      </Button>,
                    ]}
                  >
                    <div className="flex-none  h-[300px] relative items-center">
                      <img src={`/exchange-${modalIndex}.png`} alt="" className="absolute inset-0 w-full h-full object-cover rounded-lg" loading="lazy" />
                    </div>
